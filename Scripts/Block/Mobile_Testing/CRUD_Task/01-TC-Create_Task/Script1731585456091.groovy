...
Mobile.setText(findTestObject('Object Repository/Mobile_Test/01-Create_Task/widget.EditText - Enter task title'), 'Katalon Mobile', 
    0)
...
Mobile.tap(findTestObject('Object Repository/Mobile_Test/01-Create_Task/view.View - Select Date 26'), 0)
...
Mobile.getText(findTestObject('Object Repository/Mobile_Test/01-Create_Task/widget.TextView - Verif Katalon Mobile'), 0)
