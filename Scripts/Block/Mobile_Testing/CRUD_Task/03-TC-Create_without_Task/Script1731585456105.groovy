...
Mobile.setText(findTestObject('Mobile_Test/01-Create_Task/widget.EditText - Enter task title'), 'Katalon Mobile', 0)

Mobile.setText(findTestObject('Object Repository/Mobile_Test/01-Create_Task/widget.EditText - Enter your task'), '', 0)
...
Mobile.verifyElementText(findTestObject('Mobile_Test/01-Create_Task/widget.Toast - Please add task'), '', FailureHandling.OPTIONAL)
