...
WebUI.click(findTestObject('Web_Testing/01-Registrasi_Web/drop_security_pass_advice'))
...
WebUI.setText(findTestObject('Object Repository/Web_Testing/01-Registrasi_Web/input_answerquestion'), mothermaidenname)

WebUI.verifyElementVisible(findTestObject('Web_Testing/01-Registrasi_Web/errormessage_email_ is_not_valid'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementNotClickable(findTestObject('Web_Testing/01-Registrasi_Web/button_add_register'), FailureHandling.STOP_ON_FAILURE)
