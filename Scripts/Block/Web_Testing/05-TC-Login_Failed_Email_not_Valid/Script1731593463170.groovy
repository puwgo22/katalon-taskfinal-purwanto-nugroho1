...
WebUI.setText(findTestObject('Web_Testing/02-Login/input_login_email'), 'pur')
...
WebUI.verifyElementVisible(findTestObject('Web_Testing/02-Login/texttitle_All Products'))
