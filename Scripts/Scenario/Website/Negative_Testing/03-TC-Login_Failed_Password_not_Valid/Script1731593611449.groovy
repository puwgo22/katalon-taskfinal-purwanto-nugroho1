...
WebUI.callTestCase(findTestCase('Block/Web_Testing/06-TC-Login_Failed_Pass_not_Valid'), [('email') : GlobalVariable.email_web
        , ('password') : GlobalVariable.password_web], FailureHandling.STOP_ON_FAILURE)
